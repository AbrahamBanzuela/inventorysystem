			...
			<div class="rows">
				...
				<form>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control input-sm" disabled="true" id="customers_code" size="8" maxlength="20">
					</div>
					<div class="input-group mb-3">
						<label>Last Name:</label>
						<input type="text" class="form-control input-sm" disabled="true" id="last_name" size="17" maxlength="100">
					</div>
					<div class="input-group mb-3">
						<label>First Name:</label>
						<input type="text" class="form-control input-sm" disabled="true" id="first_name" size="17" maxlength="100">
					</div>
					<div class="input-group mb-3">
						<label>Middle Name:</label>
						<input type="text" class="form-control input-sm" disabled="true" id="middle_name" size="15" maxlength="100">
					</div>
					<div class="input-group mb-3">
						<label>Address:</label>
					...
					<div class="input-group mb-3">
						<label>Contact:</label>
						<input type="text" class="form-control input-sm" disabled="true" id="contact_number" size="20" maxlength="100">
					</div>
				</form>
					
					<input type="hidden" value="0" id="customers_id">
