...
for ( $i = 0; $i < count($_SESSION["sale_details"]); $i++ ) {
	...
	$cH .= "<tr class='details' >
				...
				<td style='text-align: center'>".$_SESSION["sale_details"][$i][1]."</td>
				<td style='text-align: center'><input type='text' class='quantity1' id='quantity1".$i."' index='".$i."' value=".number_format($_SESSION["sale_details"][$i][2],2)."></td>
				<td style='text-align: center'><input type='text' class='price' id='price".$i."' index='".$i."' value=".number_format($_SESSION["sale_details"][$i][3],2)."></td>
