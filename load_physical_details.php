...
for ( $i = 0; $i < count($_SESSION["physical_inventory_details"]); $i++ ) {
	...
	$nT = round($_SESSION["physical_inventory_details"][$i][2]*$_SESSION["physical_inventory_details"][$i][3],2);
	$cH .= "<tr class='details' >
				<td style='text-align: center'>".($i+1).".</td>
				<td style='text-align: center'>".$_SESSION["physical_inventory_details"][$i][1]."</td>
				<td style='text-align: center'><input type='text' class='quantity' id='quantity".$i."' index='".$i."' value=".number_format($_SESSION["physical_inventory_details"][$i][2],2)."></td>
				<td style='text-align: center'><input type='text' class='cost' id='cost".$i."' index='".$i."' value=".number_format($_SESSION["physical_inventory_details"][$i][3],2)."></td>
